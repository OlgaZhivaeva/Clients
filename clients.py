...
if __name__ == '__main__':
    with psycopg2.connect(database="test", user="postgres", password=PASS) as conn:
        with conn.cursor() as cur:
            ...
            add_client(cur, 'Ольга', 'Живаева', 'olga.zhiv@yandex.ru', ['89101297210'])
            add_client(cur, 'Алена', 'Баринова', 'al89@mail.ru', ['89101364555', '43212', '43345'])
            add_client(cur, 'Альберт', 'Ванян', 'AlV@mail.ru')
            add_client(cur, 'Дмитрий', 'Смирнов', 'smirnov75@yandex.ru')
            ...
            delete_client(cur, get_id(cur, 'al.bar89@mail.ru'))
